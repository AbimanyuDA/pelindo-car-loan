...
export default function MainLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <aside className={cn(
        'fixed top-0 left-0 z-50 h-full w-64 bg-navy-900 text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0',
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-navy-700">
          <button
            ...
            className="flex items-center gap-3 w-full px-4 py-3 text-gray-300 hover:bg-navy-800 hover:text-white rounded-lg transition-colors duration-200"
          >
