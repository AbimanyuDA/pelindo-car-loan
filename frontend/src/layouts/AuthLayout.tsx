...
export default function AuthLayout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-secondary-800 flex">
      {/* Left Panel - Branding */}
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 text-left">
            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-lg">
              <h3 className="font-semibold text-secondary-400">Efisien</h3>
              <p className="text-sm text-gray-400">
                Proses pengajuan dan persetujuan yang cepat
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-lg">
              <h3 className="font-semibold text-secondary-400">Transparan</h3>
              <p className="text-sm text-gray-400">
                Pantau status pengajuan secara real-time
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-lg">
              <h3 className="font-semibold text-secondary-400">Terintegrasi</h3>
              <p className="text-sm text-gray-400">
                Sistem terpadu untuk semua divisi
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-lg">
              <h3 className="font-semibold text-secondary-400">Audit Trail</h3>
              <p className="text-sm text-gray-400">
                Jejak aktivitas yang tercatat dengan baik
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-gray-400 text-sm mt-8">
            © {new Date().getFullYear()} PT Pelabuhan Indonesia (Persero). All
            rights reserved.
          </p>
        </div>
      </div>
