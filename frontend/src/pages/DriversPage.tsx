...
const driverSchema = z.object({
  name: z.string().min(2, 'Nama minimal 2 karakter').max(100, 'Maksimal 100 karakter'),
  phoneNumber: z.string().min(10, 'Nomor HP minimal 10 digit').max(20, 'Maksimal 20 karakter'),
  licenseNumber: z.string().min(5, 'Nomor SIM minimal 5 karakter').max(50, 'Maksimal 50 karakter'),
...
export default function DriversPage() {
  ...
  const columns: Column<Driver>[] = [
    ...
    },
    {
      key: 'licenseNumber',
      header: 'No. SIM',
      render: (item) => <span className="font-mono text-sm">{item.licenseNumber}</span>
    },
    {
      key: 'status',
      header: 'Status',
