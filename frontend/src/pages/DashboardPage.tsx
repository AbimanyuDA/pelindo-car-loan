...
import { dashboardService, loanRequestService, approvalService, scheduleService } from '@/services'
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Selamat datang di Sistem Peminjaman Kendaraan</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          {recentRequests.length === 0 ? (
            <p className="text-gray-500 text-center py-8">Belum ada pengajuan</p>
          ) : (
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {formatDate(request.departureDate)} • {request.destination}
                    </p>
                  </div>
          ...
          {!pendingApprovals || pendingApprovals.length === 0 ? (
            ...
            <div className="space-y-4">
              {pendingApprovals.map((approval) => (
                ...
                >
                  <div>
                    <p className="font-medium text-gray-900">{approval.purpose}</p>
                    <p className="text-sm text-gray-500">
                      {approval.requesterName} • {approval.department}
                    </p>
                    <p className="text-sm text-gray-500">
                      {formatDate(approval.departureDate)} • {approval.destination}
                    </p>
                  </div>
              ...
              {upcomingSchedules.map((schedule) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {formatDate(schedule.departureDate)} • {schedule.destination}
                    </p>
                    <p className="text-sm text-gray-500">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {!dashboard?.recentRequests || dashboard.recentRequests.length === 0 ? (
              ...
              <div className="space-y-4">
                {dashboard.recentRequests.map((request) => (
                  ...
                  >
                    <div>
                      <p className="font-medium text-gray-900 text-sm">{request.purpose}</p>
        ...
        <Card>
          ...
          <CardContent>
            {!dashboard?.todaySchedulesList || dashboard.todaySchedulesList.length === 0 ? (
              ...
              <div className="space-y-4">
                {dashboard.todaySchedulesList.map((schedule) => (
                  ...
                  >
                    <div>
                      <p className="font-medium text-gray-900 text-sm">{schedule.destination}</p>
