...
const loanRequestSchema = z.object({
  purpose: z.string().min(5, 'Tujuan minimal 5 karakter').max(200, 'Tujuan maksimal 200 karakter'),
  destination: z.string().min(3, 'Destinasi minimal 3 karakter').max(200, 'Destinasi maksimal 200 karakter'),
  ...
  passengerCount: z.coerce.number().min(1, 'Minimal 1 penumpang').max(20, 'Maksimal 20 penumpang'),
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Ajukan Peminjaman</h1>
          <p className="text-gray-600">Isi form berikut untuk mengajukan peminjaman kendaraan</p>
        </div>
      </div>
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardContent className="py-4">
          <h4 className="font-medium text-blue-900 mb-2">Informasi Proses Approval</h4>
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Pengajuan akan diteruskan ke PIC Approval Level 1</li>
            <li>• Setelah disetujui L1, akan diteruskan ke PIC Approval Level 2</li>
            <li>• Kendaraan dan driver akan dijadwalkan otomatis setelah approval L2</li>
            <li>• Anda akan mendapat notifikasi untuk setiap perubahan status</li>
          </ul>
        </CardContent>
      </Card>
    </div>
